...
<script setup lang="ts">
    ...
    import Sidebar from '@/components/layout/starter-sidebar.vue';
    import Header from '@/components/layout/starter-header.vue';
    import Footer from '@/components/layout/starter-footer.vue';
    import Setting from '@/components/theme-customizer.vue';
